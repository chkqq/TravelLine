...
namespace FIO
{
    ...
    {
        public static string ReadingAndValidate(string pattern)
        {
            string data = "";
        ...
        static void Main(string[] args)
        {
            ...
            string fio = ReadingAndValidate(fioPattern).Replace(" ", Environment.NewLine);

            Console.WriteLine("Введите ваш возраст:");
            string age = ReadingAndValidate(agePattern);

            Console.WriteLine("Введите ваш email(**@****.**):");
            string email = ReadingAndValidate(emailPattern);

            Console.WriteLine("Введите ссылку на ваш github:");
            string github = ReadingAndValidate(gitPattern);
